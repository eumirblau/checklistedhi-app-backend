...
const LoginScreen = ({ navigation }: Props) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Navegar a JefesScreen con datos de usuario
      navigation.replace('JefesScreen', { usuario: usuarioData });
    } catch (error) {
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.formContainer}>
            ...
            <TouchableOpacity
              ...
              disabled={loading}
            >
              <View style={[styles.loginButtonGradient, styles.gradientBackground]}>
                {loading ? (
